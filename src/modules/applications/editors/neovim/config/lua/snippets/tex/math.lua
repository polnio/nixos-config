...
return {
	...
	s(
		{ trig = "bn", snippetType = "autosnippet", wordTrig = false },
		fmta("\\mathscr{<>}", { d(1, helpers.get_visual) }),
		{ condition = helpers.in_mathzone }
	),
	-- TEXT SUBSCRIPT
	s(
	...
	s(
		{ trig = "([^%a])nn", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
		fmta("<>\\norm{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([^%a])sn", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
		fmta("<>\\sn{<>}{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([^%a])dp", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
		fmta("<>\\dd{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
	...
	s(
		{ trig = "([^%a])dt", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
		fmta("<>\\dot{<>}", {
			f(function(_, snip)
				return snip.captures[1]
			end),
