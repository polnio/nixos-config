{ pkgs, inputs, ... }:
# catppuccin-firefox-gnome = pkgs.fetchurl {
#   url = "https://github.com/GradienceTeam/Plugins/raw/f51cfd8937846dcccefaf347ba21429efd2fcbad/firefox_gnome_theme.py";
# };
{
  programs.firefox = {
    enable = true;
  ...
  home.file.".mozilla/firefox/default/chrome/firefox-gnome-theme/customChrome.css".source = ./customChrome.css;
}
